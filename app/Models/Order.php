...
class Order extends Model
{
    ...
    protected $primaryKey = 'order_id'; // 👈 use order_id as the primary key
    public $incrementing = false; // 👈 since it's a string like 'ORD_xxx'
    protected $keyType = 'string'; // 👈 make sure Laravel doesn't treat it as int
