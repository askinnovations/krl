...
@section('title', 'Stock Transfer | KRL')
@section('content')
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <div>
                                        <h4 class="card-title">🏢 Stock Transfer Listing</h4>
                                        <p class="card-title-desc">
                                            View, edit, or delete Stock Transfer details below.
                                        </p>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-light view-btn" data-bs-toggle="modal"
                                                        data-bs-target="#viewWarehouseModal"><a href=""></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p><strong>🏭 Stock Transfer:</strong> <span id="viewWarehouseName"></span></p>
                    ...
                    <div class="modal fade" id="addWarehouseModal" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="addWarehouseModalLabel">🏢 Add Stock Transfer</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                    ...
                    <div class="modal fade" id="editWarehouseModal" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editWarehouseModalLabel">✏️ Edit Stock Transfer</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
