                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="card-title-desc">
                                    View, edit, or delete employees records below. This table supports search,
                                    sorting, and pagination via DataTables.
                                </p>
                            </div>
                            <button class="btn" id="addMaintenanceBtn"
                                style="background-color: #ca2639; color: white; border: none;" data-bs-toggle="modal"
            ...
            <div id="viewMaintenanceModal" class="modal fade" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p><strong>👨‍💼 Employee:</strong> <span id="viewVehicle"></span></p>
                            <p><strong>📱 phone Number:</strong> <span id="viewVendor"></span></p>
                        </div>
                    </div>
                </div>
            </div>
